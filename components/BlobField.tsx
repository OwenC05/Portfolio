...
export default function BlobField({ animate, reduced }: Props) {
  ...
  const glowTiming = animate && !reduced ? { duration: 1.2, times: [0, 0.8, 1], ease: 'easeOut' as const } : undefined
  const fadeTimingReduced = animate && reduced ? { duration: 0.2, ease: 'easeOut' as const } : undefined
      ...
      <LazyMotion features={domAnimation}>
        <m.div
          ...
          style={{
            ...
            backgroundImage: 'radial-gradient(closest-side, #7aa2ff 0%, transparent 70%)',
          }}
          animate={glowKeyframes(o1) || (animate && reduced ? { opacity: o1 } : undefined)}
        ...
        <m.div
          ...
          style={{
            ...
            backgroundImage: 'radial-gradient(closest-side, #59e0ff 0%, transparent 70%)',
          }}
          animate={glowKeyframes(o2) || (animate && reduced ? { opacity: o2 } : undefined)}
        ...
        <m.div
          ...
          style={{
            ...
            backgroundImage: 'radial-gradient(closest-side, #8bb0ff 0%, transparent 70%)',
          }}
          animate={glowKeyframes(o3) || (animate && reduced ? { opacity: o3 } : undefined)}
